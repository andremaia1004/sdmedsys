    ...
    return (
        <div>
            <div style={{ marginBottom: '2rem' }}>
                <Link href="/admin/patients" style={{ color: 'var(--primary)', textDecoration: 'none', fontSize: '0.875rem' }}>← Voltar para Lista</Link>
                <h1 style={{ marginTop: '0.5rem' }}>Prontuário (Admin)</h1>
            </div>
