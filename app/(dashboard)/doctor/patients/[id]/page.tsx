    ...
    return (
        <div>
            <div style={{ marginBottom: '2rem' }}>
                <Link href="/doctor/agenda" style={{ color: 'var(--primary)', textDecoration: 'none', fontSize: '0.875rem' }}>← Voltar para Agenda</Link>
                <h1 style={{ marginTop: '0.5rem' }}>Perfil do Paciente</h1>
            </div>
